                ...
                <div class="tab-pane fade show active" id="candidato" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <div class="btn-group btn-toggle"> 
                    ...
                    <div class="row register-form">
                                    ...
                                    <?php 
                                        if(!empty($arrsectorind)){
                                            foreach ($arrsectorind as $sector) {
                                                echo "<option value='".$sector['id_sectorindustrial']."'>".utf8_encode($sector['descripcion'])."</option>";
                                            }
                                        }
                                    ?>
                                </select>
                            ...
                            <div class="col-md-6 col-xs-12 form-group">
                                <label class="campo">Tipo de documentación <span class="no">*</span></label>
                                <div></div>
                            ...
                            <div class="col-md-6 col-xs-12 form-group">
                                <label class="campo">Fecha de nacimiento <span class="no">*</span></label>
                                <div></div>
                            ...
                            <div class="col-md-6 col-xs-12 form-group">
                                <label class="campo">Teléfono <span class="no">*</span></label>
                                <div></div>
